...
namespace WebInstituto.Controllers
{
    ...
    {
        private readonly AlfredoBcSenatiViContext _context;

        public ProfesoresController(AlfredoBcSenatiViContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'AlfredoBcSenatiViContext.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AlfredoBcSenatiViContext.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
